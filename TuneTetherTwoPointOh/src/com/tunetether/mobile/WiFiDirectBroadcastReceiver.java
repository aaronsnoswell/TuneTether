...
public class WiFiDirectBroadcastReceiver extends BroadcastReceiver {
     ...
     */
    public WiFiDirectBroadcastReceiver(WifiP2pManager manager, Channel channel, WifiWrapper wifiwrapper) {
        super();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            if (state == WifiP2pManager.WIFI_P2P_STATE_ENABLED) {
            	...
            	wifiwrapper.setIsWifiP2pEnabled(true);
            } else {
            	wifiwrapper.setIsWifiP2pEnabled(false);
                //activity.resetData();

            }
            Lg.d("P2P state changed - " + state);
        	...
        	WifiWrapper.getInstance().setDevice(device);
