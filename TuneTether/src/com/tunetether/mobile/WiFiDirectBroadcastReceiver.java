...
public class WiFiDirectBroadcastReceiver extends BroadcastReceiver {
     ...
     */
    public WiFiDirectBroadcastReceiver(WifiP2pManager manager, Channel channel, MyApplication application) {
        super();
            ...
            if (manager != null) {
                manager.requestPeers(channel, new PeerListListener() {
					...
					public void onPeersAvailable(WifiP2pDeviceList peers) {
						application.peersAreAvailable(peers);
					}
				});
            }
            ...
            if (networkInfo.isConnected()) {
                ...
                manager.requestConnectionInfo(channel, new ConnectionInfoListener() {
					...
					public void onConnectionInfoAvailable(WifiP2pInfo info) {
						application.connectionInfoIsAvailable(info);
					}
				});
            } else {
                // We are disconnected
